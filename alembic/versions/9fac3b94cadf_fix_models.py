...
Revision ID: 9fac3b94cadf
Revises: 8e192dae5244
Create Date: 2025-03-14 03:21:53.314932
...
revision: str = '9fac3b94cadf'
down_revision: Union[str, None] = '8e192dae5244'
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('name', sa.Enum('ADMIN', 'MANAGER', 'USER', name='roleenum'), nullable=False),
    sa.Column('description', sa.String(), nullable=True),
    sa.Column('created_at', sa.Integer(), nullable=False),
    sa.Column('updated_at', sa.Integer(), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('delinquency_status', sa.Enum('NONE', 'MINOR', name='delinquencyenum'), nullable=True),
    sa.Column('created_at', sa.Integer(), nullable=False),
    sa.Column('updated_at', sa.Integer(), nullable=False),
